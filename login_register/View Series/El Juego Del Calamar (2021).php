...
<div class="mobile-player" id="mobilePlayer">
  ...
  <div class="info">
    <i class="fal fa-calendar-alt"></i><span id="season-year">2021</span>
  ...
  <div class="info-pelicula">
    ...
    <span class="genero-badge">Accion • Drama • Crimen</span>
    <!-- BOTÓN TEMPORADAS -->
<div class="series-ui">
...
<div id="episodes-container" class="episodes-scroll"></div>
    ...
    <div class="ficha-tecnica" style="text-align:center;margin-top:20px;font-size:0.9rem;color:#ccc;">
      ...
      <p><strong>Reparto:</strong> Lee Jung-jae, Wi Ha-jun, Lee Byung-hun</p>
      <p><strong>Estreno:</strong> 17/08/2021 | <strong>Idioma:</strong> Español Latino 🇲🇽</p>
    </div>
...
===================================================== */
const SERIES_KEY = "el_juego_del_calamar_2021"; // 🔑 ÚNICA POR SERIE
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  btn.addEventListener("click",function(){
    ...
    const titulo = "El juego del calamar";
    const movie_id = "en_el_juego_del_calamar";
    const imagen = "https://image.tmdb.org/t/p/w300/xNvlt4jn2KbuKJoZ9UiVpm7lYjr.jpg";
...
<script>
  ...
  <div class="recomendaciones">
    ...
    <div class="series-grid">
      <a href="html" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/AvOcYB2lcqRFvhq3ybJlcXgpRRu.jpg" alt="">
        <p>El juego del calamar: El desafío</p>
      </a>
      <a href="" class="serie">
...
========================= */
const titulo = "El juego del calamar";
  const movieId = "en_el_juego_del_calamar";
  const tipo = "serie";
  const archivo = "../View Series/El Juego Del Calamar (2021).php";
  const imagen = "https://image.tmdb.org/t/p/w300/xNvlt4jn2KbuKJoZ9UiVpm7lYjr.jpg";
