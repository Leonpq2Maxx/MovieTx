...
<div class="mobile-player" id="mobilePlayer">
  ...
  <div class="info">
    <i class="fal fa-calendar-alt"></i><span id="season-year">2025</span>
  ...
  <div class="info-pelicula">
    <h1>It: Bienvenidos a Derry</h1>
    <span class="genero-badge">Terror • Misterio</span>
    <!-- BOTÓN TEMPORADAS -->
<div class="series-ui">
...
<div id="episodes-container" class="episodes-scroll"></div>
    ...
    <div class="ficha-tecnica" style="text-align:center;margin-top:20px;font-size:0.9rem;color:#ccc;">
      ...
      <p><strong>Reparto:</strong> Taylou Paige, Jovan Adepo, James Remar</p>
      <p><strong>Estreno:</strong> 26/10/2025 | <strong>Idioma:</strong> Español Latino 🇲🇽</p>
    </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  btn.addEventListener("click",function(){
    ...
    const titulo = "It: Bienvenido a Derry";
    const movie_id = "it_bienvenidos_a_derry";
...
<script>
  ...
  <div class="recomendaciones">
    ...
    <div class="series-grid">
      <a href="../View Peliculas/Reproductor Universal.php?id=it_2017" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/kI2c93Ybv8C8seSJunNSlpepFPX.jpg" alt="">
        <p>It (Eso)</p>
      </a>
      <a href="../View Peliculas/It Capítulo 2 (2019).html" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/pxw6j2AwlUsw5iS4fCxPoCP0jPh.jpg" alt="">
        <p>It: Capitulo 2</p>
      </a>
      <a href="../View Peliculas/El payaso del mal (2014).html" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/o4bNaBX6COOzgvWQGLSNuIbztvF.jpg" alt="">
        <p>El payaso del mal</p>
      </a>
      <a href="../View Peliculas/Terrifier 3 Payaso (2024).html" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/ju10W5gl3PPK3b7TjEmVOZap51I.jpg" alt="">
        <p>Terrifier</p>
      </a>
      <a href="../View Peliculas/Until Dawn Noche de terror (2025).html" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/vAYTXSUnQjmTFcm97BhROQav1wF.jpg" alt=""> <!--EN CASO DE NO SER PARA ADULTOS UTILICE ESTAS 6 ESTRUCTURAS DEL CODIGO, LA DE ABAJO ES PARA ADULTOS. SI NO CONTIENES PELICULAS DE ADULTOS UTILIZA LAS 6 QUE DEJARE MARCADA CON NUMEROS DEL (1 AL 6) EN CASO DE TENER PELICULA DE ADULTOS UTILIZA EL DE ABAJO-->
        <p>Until Dawn: Noche de terror</p>
      </a>
      <a href="../View Peliculas/Háblame (2023).html" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/rS8fjd6dYcf64v3ZhAE6fKrxoaF.jpg" alt="">
        <p>Háblame</p>
      </a>
    </div>
  </div>
