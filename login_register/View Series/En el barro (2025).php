...
<div class="mobile-player" id="mobilePlayer">
  ...
  <div class="info-pelicula">
    <h1>En el barro</h1>
    <span class="genero-badge">Crimen • Drama</span>
    <!-- BOTÓN TEMPORADAS -->
<div class="series-ui">
...
<div id="episodes-container" class="episodes-scroll"></div>
    ...
    <p class="sinopsis">
      Cinco prisioneras forjan un vínculo único después de un accidente mortal... hasta que la corrupción y las guerras territoriales dentro de una prisión despiadada amenazan con destruirlas.
    </p>

    <div class="ficha-tecnica" style="text-align:center;margin-top:20px;font-size:0.9rem;color:#ccc;">
      <p><strong>Director:</strong> Sebastián Ortega</p>
      <p><strong>Reparto:</strong> Ana 6aribaldi, Valentina Zenere, Rita Cortese</p>
      <p><strong>Estreno:</strong> 14/08/2025 | <strong>Idioma:</strong> Argentina 🇦🇷</p>
    </div>
...
===================================================== */
const SERIES_KEY = "en_el_barro_2025"; // 🔑 ÚNICA POR SERIE
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  btn.addEventListener("click",function(){
    ...
    const titulo = "En el barro";
    const movie_id = "en_el_barro";
    const imagen = "https://image.tmdb.org/t/p/w300/vQANo4LO7Hi57XxQqhRWeAZkD5h.jpg";
...
<script>
  ...
  <div class="recomendaciones">
    ...
    <div class="series-grid">
      <a href="The Walking Dead (2010).html" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/original/9iYinsg30olSCuDoH8VxtRN5gZx.jpg" alt="">
        <p>The Walking Dead</p>
      </a>
      <a href="" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/original/eAy2tSlGtzseWfYemt398QrPtf2.jpg" alt="">
        <p>El Marginal</p>
      </a>
      <a href="" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/original/kY0BogCM8SkNJ0MNiHB3VTM86Tz.jpg" alt="">
        <p>Chucky</p>
      </a>
      <a href="" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/original/9CSTzX1pUrNLD7lsJ8h9hRFJtLQ.jpg" alt="">
        <p>Duki: Desde el fin del mundo</p>
      </a>
      <a href="" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/original/8PT42NbjTZzYzCnPzg4NZzSW97n.jpg" alt="">
        <p>Dragon Ball Z</p>
      </a>
      <a href="" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/original/wfxsizfb7NV9uwy9QCqqvfR20F2.jpg" alt="">
        <p>Dr.House</p>
      </a>
    </div>
  </div>
...
========================= */
const titulo = "En el barro";
  const movieId = "en_el_barro";
  const tipo = "serie";
  const archivo = "../View Series/En el barro (2025).php";
  const imagen = "https://image.tmdb.org/t/p/w300/vQANo4LO7Hi57XxQqhRWeAZkD5h.jpg";
