...
<div class="mobile-player" id="mobilePlayer">
  ...
  <div class="info">
    <i class="fal fa-calendar-alt"></i><span id="season-year">2010</span>
  ...
  <div class="info-pelicula">
    ...
    <span class="genero-badge">Accion • Drama • Apocalipsis</span>
    <!-- BOTÓN TEMPORADAS -->
<div class="series-ui">
...
<div id="episodes-container" class="episodes-scroll"></div>
    ...
    <p class="sinopsis">
      El ayudante del sheriff Rick Grimes despierta de un coma y se encuentra en un mundo postapocalíptico dominado por zombis devoradores de carne. Se lanza a la búsqueda de su familia y, en el camino, se topa con muchos otros supervivientes.
    </p>
    ...
    <div class="ficha-tecnica" style="text-align:center;margin-top:20px;font-size:0.9rem;color:#ccc;">
      ...
      <p><strong>Reparto:</strong> Andrés Lincoln, Norman Reedus, Lauren Cohan</p>
      <p><strong>Estreno:</strong> 31/10/2010 | <strong>Idioma:</strong> Español Latino 🇲🇽</p>
    </div>
...
===================================================== */
const SERIES_KEY = "The_walking_dead"; // 🔑 ÚNICA POR SERIE
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  btn.addEventListener("click",function(){
    ...
    const movie_id = "the_walking_dead";
    const imagen = "https://image.tmdb.org/t/p/w300/9iYinsg30olSCuDoH8VxtRN5gZx.jpg";
...
<script>
  ...
  <div class="recomendaciones">
    ...
    <div class="series-grid">
      <a href="The Walking Dead The ones two live (2024).html" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/t1yUeYKw3s0VntQxzdUgza4msGU.jpg" alt="">
        <p>The Walking Dead: The ones two lives</p>
      </a>
      <a href="" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/kdM24KINoAVK9wjCtDJCkdffEpc.jpg" alt="">
        <p>The Walking Dead: Daryl Dixon</p>
      </a>
      <a href="" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/yd8cDZG4XjNRk7jfEWy18KH07d2.jpg" alt="">
        <p>Fear The Walking Dead</p>
      </a>
      <a href="" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/ugdiqJsceA9slg2k4Uu6VKegaw8.jpg" alt="">
        <p>The Walking Dead: Dead city</p>
      </a>
      <a href="" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/6HanIV2hTLE2w7A5bI1KJb3bTL7.jpg" alt="">
        <p>The Walking Dead: World Beyond</p>
      </a>
      <a href="" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/zRMUHvTgQ79zteQafNI46Nd9XFm.jpg" alt="">
        <p>Tales Of The Walking Dead</p>
      </a>
    </div>
  </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const titulo = "The Walking Dead";
  const movieId = "the_walking_dead";
  const tipo = "serie";
  const archivo = "../View Series/The Walking Dead (2010).php";
  const imagen = "https://image.tmdb.org/t/p/w300/9iYinsg30olSCuDoH8VxtRN5gZx.jpg";
