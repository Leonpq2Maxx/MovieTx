...
<div class="mobile-player" id="mobilePlayer">
  ...
  <div class="info">
    ...
    <i class="fal fa-thumbs-up"></i><span>92%</span>
    <div class="hd-tag">
  ...
  <span id="genero-texto">Anime • Animación</span>
</span>
    <!-- BOTÓN TEMPORADAS -->
<div class="series-ui">
...
<div id="episodes-container" class="episodes-scroll"></div>
    ...
    <div class="ficha-tecnica" style="text-align:center;margin-top:20px;font-size:0.9rem;color:#ccc;">
      <p><strong>Director:</strong> Luis Daniel Garza</p>
      <p><strong>Reparto:</strong> Armando Guerrero, Diego Becerril, Lalo Garza</p>
      <p><strong>Estreno:</strong> 09/10/2022 | <strong>Idioma:</strong> Español Latino 🇲🇽</p>
    </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  btn.addEventListener("click",function(){
    ...
    const titulo = "Blue Lock";
    const movie_id = "blue_lock";
    const imagen = "https://image.tmdb.org/t/p/w300/1DFhWgHKzzlzAvrmK8ZzLx4XcTY.jpg";
...
.genero-badge {
  ...
  <div class="recomendaciones">
    ...
    <div class="series-grid">
      <a href="Blue Lock la película -episodio Nagi- (2024).php" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/tT7wk65X4czBIxDjoPRMNw5JhKD.jpg" alt="">
        <p>Blue Lock: La película - episodio Nagi</p>
      </a>
      <a href="capitan tsubasa.php" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/zHgc9nTXiP77qoy14BO7WUFTwkp.jpg" alt="">
        <p>Capitan Tsubasa</p>
      </a>
      <a href="hajime no ippo (2000).php" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/i3U3J2MWovIBZBnZYYiOLBXqNJZ.jpg" alt="">
        <p>Hajime no ippo</p>
      </a>
      <a href="Dragon Ball GT.php" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/pLYjbFYHOX1SrHs5BQsGlmv83lZ.jpg" alt="">
        <p>Dragon Ball Gt</p>
      </a>
      <a href="Baki-Dou El samurái invencible (2026).php" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/vIbiGAJR69775GHFlYlPFG4GSpb.jpg" alt="">
        <p>Baki-Dou: El samurái invensible</p>
      </a>
      
      <a href="los siete pecados capitales.php" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/by5ZMxYI4RD4CzKMJhX6X74JhFl.jpg" alt="">
        <p>Los siete pecados capitales: El rencor de edimburgo</p>
      </a>
    </div>
  </div>
...
========================= */
const titulo = "Blue Lock";
const movieId = "blue_lock";
const tipo = "serie";
const archivo = "../View Series/Blue Lock (2022).php";
const imagen = "https://image.tmdb.org/t/p/w300/1DFhWgHKzzlzAvrmK8ZzLx4XcTY.jpg";
