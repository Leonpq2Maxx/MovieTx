...
<div class="mobile-player" id="mobilePlayer">
  ...
  <div class="info-pelicula">
    <h1>Baki</h1>
    <span class="genero-badge">Accion • Anime • Animacion</span>
    <!-- BOTÓN TEMPORADAS -->
<div class="series-ui">
...
<div id="episodes-container" class="episodes-scroll"></div>
    ...
    <p class="sinopsis">
      Mientras el campeón de artes marciales Baki Hanma entrena duro para superar a su legendario padre, cinco violentos presos condenados a muerte descienden sobre Tokio para enfrentarse a él.
    </p>

    <div class="ficha-tecnica" style="text-align:center;margin-top:20px;font-size:0.9rem;color:#ccc;">
      <p><strong>Director:</strong> Toshiki Hirano</p>
      <p><strong>Reparto:</strong> Nobunaga Shimazaki, Kenjiro Tsuda, Takehito Koyasu</p>
      <p><strong>Estreno:</strong> 25/06/2018 | <strong>Idioma:</strong> Español Latino 🇲🇽</p>
    </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  btn.addEventListener("click",function(){
    ...
    const titulo = "Baki";
    const movie_id = "baki_2018";
    const imagen = "https://image.tmdb.org/t/p/w300/j4bL0G8h8k49MuXKYfZqhXqk2rI.jpg";
...
<script>
  ...
  <div class="recomendaciones">
    ...
    <div class="series-grid">
      ...
      <a href="Los siete pecados capitales (2014).html" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/dWEKYfDkaTpx3BZsXbSnf0U9G4X.jpg" alt="">
        <p>Los siete pecados capitales</p>
      </a>
      <a href="Dragon Ball Z (1989).html" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/8PT42NbjTZzYzCnPzg4NZzSW97n.jpg" alt="">
        <p>Dragon Ball Z</p>
      </a>
      <a href="../View Peliculas/Demon Slayer Kimetsu no Yaiba Infinity Castle (2025).html" class="serie">
        <img loading="lazy" src="https://image.tmdb.org/t/p/w300/fWVSwgjpT2D78VUh6X8UBd2rorW.jpg" alt="">
...
========================= */
const titulo = "Baki";
  const movieId = "baki_2018";
  const tipo = "serie";
  const archivo = "../View Series/Baki (2018).php";
  const imagen = "https://image.tmdb.org/t/p/w300/j4bL0G8h8k49MuXKYfZqhXqk2rI.jpg";
